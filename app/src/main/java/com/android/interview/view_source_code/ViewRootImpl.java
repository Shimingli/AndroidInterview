...
public final class ViewRootImpl implements ViewParent,View.AttachInfo.Callbacks, ThreadedRenderer.DrawCallbacks {
     ...
     * We have one child
     */
    // TODO: 2018/5/24  这个方法在  WindowManagerGlobal 。addView中调用
    ...
    public ViewParent invalidateChildInParent(int[] location, Rect dirty) {
        ...
        // 如果是从 invalidate() 方法过来的话，那么dirty 肯定不为null  因为要是为null的话，前面调用方法的地方就抛出了空指针的异常
         //  todo 在View中调用的方法地方
...
//        damage.set(l, t, r, b);
        ...
        if (mCurScrollY != 0 || mTranslator != null) {
            ...
            if (mCurScrollY != 0) {
                ...
                //通过将dx=0添加到其左、右坐标，并将 mCurScrollY 添加到其顶部和底部坐标来抵消矩形。
    ...
    /**
     * todo 关键的方法  mTraversalRunnable 这个子线程
     */
