...
//     *          current values.
//     todo    新窗口属性，它将完全覆盖任何当前值。
//     */
////    *指定自定义窗口属性。<强>请注意：< /强>
////            *这里给出的布局参数通常应该来自先前的值。
////            *用{Link Lang-GETAdvestTeMe（）}检索；您可能不希望
////*盲目地创建和应用自己，因为这会吹走任何值。
////            *由您不感兴趣的框架设置。
//    // TODO: 2018/6/4 在这里决定了是否会 onMeasure两次
...
//     * @see #setMediaController(MediaController)
...
//     * {@link #setSharedElementExitTransition(Transition)}.
//     * Requires {@link #FEATURE_ACTIVITY_TRANSITIONS}.
//     *
//     * @param transition The Transition to use for shared elements in the launching Window
...
//     * {@link #setEnterTransition(Transition)} overlaps with the exit
...
//    /**
//     * Controls how the transition set in
//     * {@link #setExitTransition(Transition)} overlaps with the exit
