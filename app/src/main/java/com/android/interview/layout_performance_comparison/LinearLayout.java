...
//        }
//        /*
//        android:weightSum属性在官方文档中的解释包含下面的内容：
//        “定义weight综合的最大值，如果未指定该值，
//        以所有子师徒的layout_weight属性的累加值作为总和的最大值。
//        典型案例是：通过指定子视图的layout_weight属性为0.5.
//        并设置LinearLayout的weightSum属性为1.0，实现子视图占据可用宽高的50%
//         */
//        // TODO: 2018/5/30  一般我们使用全中的话，都没有设置这个值
//        /*
...
//     * @attr ref android.R.styleable#LinearLayout_divider
//     */
//    // TODO: 2018/5/30 设置一个可作为项目之间的分隔符的可绘制性。
...
//        //根据方向来测量
//        //由于java中的int值在不分配的时候，默认的都是0，因此LinearLayout的方法默认是水平的
//        if (mOrientation == VERTICAL) {
...
//            //如果LinearLayout的子布局设置了weight，一般这个WeightSum是没有设置的 会走到
//            //totalWeight来
//            // TODO: 2018/5/30  垂直的
...
//                    // 全篇最精华的一个地方。。。。拥有weight的时候计算方式,ps:执行到这里时，
//                    // child依然还没进行自身的measure
...
//        // TODO: 2018/5/30 这个就是最终得到的整个LinearLayout的高度（子控件高度累加及自身padding）
//        mTotalLength = 0;
...
//            // TODO: 2018/5/30 确认还在放置的位置
//            // TODO: 2018/5/30 dvider的位置，总体的长度，加上这个宽度
//            if (hasDividerBeforeChildAt(i)) { // TODO: 2018/5/30 确认还在放置的位置
...
//            // 我们都知道，测量模式有三种：
//            // * UNSPECIFIED：父控件对子控件无约束
//            // * Exactly：父控件对子控件强约束，子控件永远在父控件边界内，越界则裁剪。
//            // 如果要记忆的话，可以记忆为有对应的具体数值或者是Match_parent
//            // * AT_Most：子控件为wrap_content的时候，测量值为AT_MOST。
...
//                }
//            }
//           //这个为true的时候，表明这个Mode模式是精确的，同时height是match_parent
