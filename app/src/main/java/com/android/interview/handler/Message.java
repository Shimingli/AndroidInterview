...
//public final class Message  implements Parcelable{//implements Parcelable
//    /**
...
//     */
//    // TODO: 2018/5/17  享元模式   设计模式，感觉这个更加的牛逼啊  哈哈 这种的实现的方式
//
//    //Message Pool消息池的概念——重复利用Message
//
//    /*
//    通过obtain方法取出一条消息的时候，如果发现当前的消息池不为空，那就直接重复利用Message（已经被创建过和handle过的）；
//    如果为空就重新new 一个消息。这就是一种享元设计模式的概念。例如在游戏里面，发子弹，如果一个子弹是一个对象，
//    一按下按键就发很多个子弹，那么这时候就需要利用享元模式去循环利用了
//    */
